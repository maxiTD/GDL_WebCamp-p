...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			...
			<small>puedes editar o eliminar las categorías aquí</small>
		</h1>
	</section>
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Administra las categorías en esta sección</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
								...
								<?php
									...
									while ($categoria = $resultado->fetch_assoc()) { ?>
										<tr>
											...
											<td><i class="fa <?php echo $categoria['icono']; ?>"></i>
											<td>
